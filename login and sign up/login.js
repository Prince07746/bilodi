...
<center>
	...
	<div class="container">
		<h1>Login</h1>
		<form action="/login" method="post" id="form-signup">
			<input type="text" name="email" placeholder="name" required>
			<input type="password" name="password" placeholder="Password" required>
			<input type="submit" value="Login">
		</form>
        <form action="/signupRequest" method="get" id="form-signup">
...
<center>
	<div class="container">
		...
		<form action="/login" method="post" id="form-signup">
			...
			<input type="submit" value="Login">
      <br>
      <h5 style="color: red; font-weight: bold; font-family: Arial;">verify the name or password</h5>
		</form>
    <form method="get" action="/signupRequest">
